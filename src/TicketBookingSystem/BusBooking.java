...
public class BusBooking {
    ...
    private void initializeSeats(String seatClass, double finalSeatPrice) {
        seatClass = "Standard"; // Enforce Standard
        seats.clear();
    ...
    public void book(Scanner sc, String username, String startCity, String destCity, double finalSeatPrice, String seatClass, String travelDate, String selectedProvider) {
        // Enforce Standard class, use finalSeatPrice
        seatClass = "Standard";
    ...
    public void addBooking(String bookingId, String username, String startCity, String destCity, double price, String seatClass, Seat seat, String travelDate, String provider) {
        seat.reserve(); Booking loadedBooking = new Booking(username, startCity, destCity, price, "Standard", seat, travelDate, provider); bookings.put(bookingId.toUpperCase(), loadedBooking); // Enforce Standard class on load
    }
    ...
    static class Booking { // Package-private
        ...
        public Booking(String u, String s, String d, double p, String sc, Seat se, String td, String prov) { this.username=u; this.startCity=s; this.destCity=d; this.price=p; this.seatClass="Standard"; this.seat=se; this.travelDate=td!=null?td:"N/A"; this.provider=prov!=null?prov:"N/A"; } // Enforce Standard
